...
mod call_builder {
    ...
    impl CallBuilderTest {
        ...
        /// Returns the current value of the `CallBuilder`'s boolean.
        #[ink(message)]
    ...
    mod e2e_tests {
        ...
        async fn e2e_can_flip_correctly(
            ...
            let contract_acc_id = client
                ...
                .await
                .expect("Instantiate `call_builder` failed")
                .account_id;
        ...
        async fn e2e_message_error_reverts_state(
            ...
            let err_flip_call_result = client
                .call(
                    &mut ink_e2e::bob(),
                    contract_acc_id.clone(),
                    call_builder::messages::err_flip(),
                    0,
                    None,
                )
                .await;
