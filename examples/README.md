...
You should now have an optimized `<contract-name>.wasm` file, a `<contract-name>.json` file and a `<contract-name>.contract` file in the `target` folder of your contract.
