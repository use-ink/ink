...
fn main() {
    ...
    assert_eq!(<contract::Event as ink::env::Event<ink::abi::Ink>>::SIGNATURE_TOPIC, Some(SIGNATURE_TOPIC_INK));
    ...
    assert_eq!(<contract::Event as ink::env::Event<ink::abi::Sol>>::SIGNATURE_TOPIC, Some(SIGNATURE_TOPIC_SOL));
