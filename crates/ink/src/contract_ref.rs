...
/// - The second argument is optional and specifies the type of the [`ink_env::Environment`].
///
/// If the second argument is not specified, the macro uses the `Environment` type alias
/// generated by the [`crate::contract`]. So the macro assumes to be used in the scope of
/// the [`crate::contract`] by default. It is still possible to use the macro outside
/// the contract context, but it requires specification of the environment via the second argument.
///
/// An example of usage inside of the [`crate::contract`] context:
///
/// ```rust
/// #[ink::contract]
/// mod trait_caller {
...
/// ```
///
/// An example of usage outside of the [`crate::contract`] context:
/// ```rust
/// use ink::contract_ref;
