    ...
    H256: Debug + scale::Encode,
{
    ...
    fn contract_result_to_result_foo<V, X>(
        &self,
        contract_result: BareInstantiationDryRunResult<E::Balance>,
    ) -> Result<ContractResult<V, E::Balance, X>, DryRunError<DispatchError>>
    {
