...
/// Implemented by call builders of smart contracts and by `TraitDefinitionRegistry` during
/// codegen.
///
/// For all types which implement `CallBuilder` the codegen in `#[ink_lang::trait_definition]`
/// generates the body for the methods defined by the annotated trait. These methods contain
/// cross-contract calls inside and define the `__ink_TraitInfo`.
