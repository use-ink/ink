...
pub trait DispatchableMessageInfo<const ID: u32> {
    ...
    const CALLABLE: fn(&mut Self::Storage, &[u8]) -> Result<Self::Output>;
...
pub trait DispatchableConstructorInfo<const ID: u32> {
    ...
    const CALLABLE: fn(&[u8]) -> Result<Self::Storage>;
...
/// Generated type used to execute all dispatchable ink! messages of the ink! smart contract.
///
/// # Note
///
...
/// ```
/// use ink_lang as ink;
/// # use ink_lang::reflect::{ContractMessageExecutor, ExecuteDispatchable};
...
///             <<Contract as ContractMessageExecutor>::Type as ExecuteDispatchable>
///                 ::execute_dispatchable(&input_bytes[..])
///         });
...
/// Generated type used to execute all dispatchable ink! constructors of the ink! smart contract.
///
/// # Note
///
...
/// ```
/// use ink_lang as ink;
/// # use ink_lang::reflect::{ContractConstructorExecutor, ExecuteDispatchable};
/// # use ink_lang::selector_bytes;
/// # use scale::{Encode};
///
/// #[ink::contract]
...
pub trait ExecuteDispatchable {
    ...
    fn execute_dispatchable(input: &[u8]) -> Result<()>;
}
