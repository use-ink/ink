...
impl Noop {
    pub fn deploy(&mut self, _env: &mut EnvHandler<TestEnv>) {}
    pub fn do_nothing(&self, _env: &EnvHandler<TestEnv>) {}
}

#[rustfmt::skip]
fn instantiate() -> impl Contract {
	ContractDecl::using::<Noop, TestEnv>()
		.on_deploy(|env, ()| {
