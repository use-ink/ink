...
This contract demonstrates how to interact with ERC-20 asset precompiles in ink! using the `ink::precompiles` module.

## Overview

This example shows how to:
- Use the `ink::precompiles` module for precompile interfaces
