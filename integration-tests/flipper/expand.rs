...
pub mod flipper {
    ...
    type ChainExtension = <<Flipper as ::ink::env::ContractEnv>::Env as ::ink::env::Environment>::ChainExtension;
    const MAX_EVENT_TOPICS: usize = <<Flipper as ::ink::env::ContractEnv>::Env as ::ink::env::Environment>::MAX_EVENT_TOPICS;
    const _: () = {
        struct Check {
            salt: (),
            field_0: bool,
                        ...
                        if {
                            false
                                ...
                                || {
                                    ...
                                    let constructor_1 = <Flipper as ::ink::reflect::DispatchableConstructorInfo<
                                        0x61EF7E3E_u32,
                                    >>::PAYABLE;
                                    constructor_1
                                }
