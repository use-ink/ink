...
EXAMPLES
   ...
   ${script_name} --path integration-tests -- cargo-contract contract build --manifest-path {} --release
   ${script_name} --path integration-tests --ignore erc20 -- cargo-contract contract build --manifest-path {} --release
   ${script_name} --path integration-tests --partition 1/2 --ignore erc20 -- cargo-contract contract build --manifest-path {} --release
