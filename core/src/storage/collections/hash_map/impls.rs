...
where
    K: parity_scale_codec::Encode + Flush,
    V: parity_scale_codec::Encode + Flush,
{
    fn flush(&mut self) {
        match self {
...
impl<K, V> parity_scale_codec::Encode for HashMap<K, V> {
...
impl<K, V> HashMap<K, V>
where
    K: parity_scale_codec::Codec + Hash + Eq,
    V: parity_scale_codec::Codec,
{
...
where
    K: Eq + Hash + Borrow<Q> + parity_scale_codec::Codec,
    V: parity_scale_codec::Codec,
    Q: Eq + Hash,
{
    type Output = V;
