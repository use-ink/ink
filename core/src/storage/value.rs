...
impl<T> Value<T>
where
    T: parity_scale_codec::Codec + Default,
{
...
where
    T: AsRef<R> + parity_scale_codec::Codec,
{
    fn as_ref(&self) -> &R {
        self.get().as_ref()
    }
...
macro_rules! impl_ops_for_value {
	(
		...
		where
			T: core::ops::$trait_name<T> + Copy + parity_scale_codec::Codec,
		{
		...
		where
			T: core::ops::$trait_name_assign<T> + parity_scale_codec::Codec,
		{
		...
		where
			T: core::ops::$trait_name_assign<T> + Copy + parity_scale_codec::Codec,
		{
...
where
    T: core::ops::Neg + Copy + parity_scale_codec::Codec,
{
...
where
    T: core::ops::Not + Copy + parity_scale_codec::Codec,
{
...
macro_rules! impl_shift_for_value {
	(
		...
		where
			T: core::ops::$trait_name<R> + Copy + parity_scale_codec::Codec,
		{
		...
		where
			T: core::ops::$trait_name_assign<R> + Copy + parity_scale_codec::Codec,
		{
...
where
    T: core::ops::Index<I> + parity_scale_codec::Codec,
{
...
where
    T: PartialEq + parity_scale_codec::Codec,
{
...
impl<T> Eq for Value<T> where T: Eq + parity_scale_codec::Codec {}

use core::cmp::Ordering;

impl<T> PartialOrd<T> for Value<T>
where
    T: PartialOrd + parity_scale_codec::Codec,
{
...
where
    T: Ord + parity_scale_codec::Codec,
{
...
where
    T: core::hash::Hash + parity_scale_codec::Codec,
{
...
where
    T: core::fmt::Display + parity_scale_codec::Codec,
{
