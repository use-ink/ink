...
fn count_rw_get() {
	...
	for i in 0..N {
		#[allow(unused_must_use)] { chunk.get(i); }
...
fn count_rw_get_repeat() {
	...
	// Loading from all cells.
	for _i in 0..N {
		#[allow(unused_must_use)] { chunk.get(0); }
...
fn count_rw_put() {
	...
	// Writing to all cells.
	for i in 0..N {
		#[allow(unused_must_use)] { chunk.put(i, 42); }
		assert_eq!(TestEnv::total_reads(), i as u64 + 1);
		assert_eq!(TestEnv::total_writes(), 0);
	}
	assert_eq!(TestEnv::total_reads(), N as u64);
...
fn count_rw_put_repeat() {
	...
	// Writing to all cells.
	for _i in 0..N {
		#[allow(unused_must_use)] { chunk.put(0, 42); }
		assert_eq!(TestEnv::total_reads(), 1);
		assert_eq!(TestEnv::total_writes(), 0);
	}
	assert_eq!(TestEnv::total_reads(), 1);
...
fn count_rw_take() {
	...
	// Writing to all cells.
	for i in 0..N {
		#[allow(unused_must_use)] { chunk.take(i); }
		assert_eq!(TestEnv::total_reads(), i as u64 + 1);
		assert_eq!(TestEnv::total_writes(), 0);
	}
	assert_eq!(TestEnv::total_reads(), N as u64);
...
fn count_rw_take_repeat() {
	...
	// Writing to all cells.
	for _i in 0..N {
		#[allow(unused_must_use)] { chunk.take(0); }
		assert_eq!(TestEnv::total_reads(), 1);
		assert_eq!(TestEnv::total_writes(), 0);
	}
	assert_eq!(TestEnv::total_reads(), 1);
